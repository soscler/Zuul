...
class EncryptionKey implements Serializable {
    ...
    String algorithm = ZuulDataConstants.KEY_ALGORITHM_AES
    ...
    Boolean getIsPgpKey() {
        return ZuulDataConstants.PGP_KEY_ALGORITHMS.find { it == algorithm } != null
    }

    Boolean getIsPbeKey() {
        return ZuulDataConstants.PBE_KEY_ALGORITHMS.find { it == algorithm} != null
    }
